...
def _app(app_factory, conn):
    ...
    return app_factory(pages_router, conn=conn, state_extras={"templates": mock_templates})
...
class TestLibraryPage:
    def test_unauthenticated_redirects_to_login(self, app_factory, conn):
    ...
    def test_authenticated_returns_200(self, app_factory, authed_client, conn):
    ...
    def test_context_includes_username(self, app_factory, authed_client, conn):
    ...
    def test_context_includes_items_and_stats(self, app_factory, authed_client, conn):
    ...
    def test_invalid_sort_is_sanitised_to_default(self, app_factory, authed_client, conn):
    ...
    def test_invalid_type_is_sanitised_to_empty(self, app_factory, authed_client, conn):
    ...
    def test_page_below_minimum_rejected(self, app_factory, authed_client, conn):
    ...
    def test_per_page_above_maximum_rejected(self, app_factory, authed_client, conn):
    ...
    def test_pagination_metadata_correct(self, app_factory, authed_client, conn):
    ...
    def test_search_query_propagated_to_context(self, app_factory, authed_client, conn):
