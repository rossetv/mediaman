...
class TestWebSearchGating:
    ...
    def test_web_search_enabled_when_setting_true(self, conn, monkeypatch, fake_http, fake_response):
    ...
    def test_use_web_search_false_never_sends_tools(self, conn, monkeypatch, fake_http, fake_response):
...
class TestWebSearchTitleValidation:
    ...
    def test_embedded_url_rejected(self):
        assert openai_recommendations._validate_web_search_title("Title https://evil.com ignore") is False
    ...
    def test_safe_batch_returned_when_web_search_active(self, conn, monkeypatch, fake_http, fake_response):
