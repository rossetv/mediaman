"""Tests for send_newsletter() in mediaman.services.newsletter."""
...
_PATCH_STORAGE = "mediaman.services.storage.get_aggregate_disk_usage"
# MailgunClient is imported inside the function body from mediaman.services.mailgun,
# so patch it at the source module.
_PATCH_MAILGUN = "mediaman.services.mailgun.MailgunClient"
_PATCH_RADARR  = "mediaman.services.arr_build.build_radarr_from_db"
_PATCH_SONARR  = "mediaman.services.arr_build.build_sonarr_from_db"
_PATCH_RADARR_CACHE = "mediaman.services.arr_state.build_radarr_cache"
_PATCH_SONARR_CACHE = "mediaman.services.arr_state.build_sonarr_cache"
