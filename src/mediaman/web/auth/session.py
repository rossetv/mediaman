...
- :mod:`mediaman.web.auth.password_hash` — bcrypt hashing, verification, rotation.
- :mod:`mediaman.web.auth.session_store` — session persistence, validation,
