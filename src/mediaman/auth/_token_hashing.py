...
Both :mod:`mediaman.auth.session_store` and :mod:`mediaman.auth.reauth`
...
is preserved as a private alias because tests, ``mediaman.auth.session``,
...
# and ``mediaman.auth.session`` re-export it under this name.
