...
Plex client construction and the per-settings client cache live in
:mod:`._plex_builder`; this module owns scan configuration assembly,
disk-threshold filtering, and the orchestration entry points
:func:`run_scan_from_db` and :func:`run_library_sync`.
"""
...
from mediaman.scanner._plex_builder import (
...
def run_scan_from_db(
    ...
    bundle = build_plex_client(conn, secret_key)
    if bundle is None:
