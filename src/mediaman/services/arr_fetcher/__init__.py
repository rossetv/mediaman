...
``from mediaman.services.arr_fetcher import FetchResult, fetch_arr_queue``
...
from mediaman.services.arr_fetcher._base import (
    ArrCard,
    ArrEpisodeEntry,
    BaseArrCard,
    FetchResult,
)
from mediaman.services.arr_fetcher._radarr import fetch_radarr_queue
from mediaman.services.arr_fetcher._sonarr import fetch_sonarr_queue
