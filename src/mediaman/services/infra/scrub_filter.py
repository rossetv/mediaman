"""Defence-in-depth — scrubs token/key substrings from log records emitted by
third-party libraries that may otherwise leak credentials in DEBUG mode
(urllib3, requests).  Idempotent so module re-imports don't stack filters.
