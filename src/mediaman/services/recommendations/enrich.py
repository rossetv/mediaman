...
from mediaman.services.recommendations.prompts import strip_season_suffix


def enrich_recommendations(
    recommendations: list[dict], conn: sqlite3.Connection
) -> None:
    ...
    for s in recommendations:
        if client is not None:
            ...
            if tmdb_id:
                ...
                if data:
                    detail = TmdbClient.shape_detail(data, media_type=s["media_type"])
